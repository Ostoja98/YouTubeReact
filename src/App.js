...
class App extends Component {
  ...
  fetchData() {
    fetch(
      `https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=10&key=AIzaSyAOzECROKfyokMUW8AIdB29ZkLXfTCFWwE&q=${this.state.searchValue}`
    )
      .then((res) => res.json())
  ...
  render() {
    return (
      <div>
        <HomePage
          iFrame={this.state.isVideoSelected}
